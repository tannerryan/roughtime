...
// sigScheme identifies the signature algorithm.
type sigScheme int

const (
	// schemeEd25519 is the Ed25519 signature scheme.
	schemeEd25519 sigScheme = iota
	// schemeMLDSA44 is the ML-DSA-44 signature scheme.
	schemeMLDSA44
)

// String returns a short name for the scheme.
...
// schemeOf returns the signature scheme used by a Roughtime version.
